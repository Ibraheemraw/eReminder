 ...
 //Private Properties
   ...
   private var searchController: UISearchController!
    override func viewDidLoad() {
        ...
        tableViewData = [cellData.init(opened: false, title: "First Connection", sectionData: ["Email", "Location where they met"]), cellData.init(opened: false, title: "Second Connection", sectionData: ["Email", "Location where they met"]), cellData.init(opened: false, title: "Third Connection", sectionData: ["Name", "Email", "Description of the person", "Location where they met"])]
